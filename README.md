...
### 从 4.2.1-Y700G4_C16 (safe 4211 / full 4212) 升级

> ⚠️ 4.2.1 包内缺失 `updateJson`（4.2.2 已修复此问题），KSU Manager 检查不到更新提示，请从 Releases 下载 4.2.2 对应变体**直接覆盖刷入**（id 相同），重启生效。此后自动更新通道恢复正常。
...
- 自动：KSU Manager → 模块 → 检查更新（safe/full/触控各有独立通道；extreme_gt 自动通道自 4.2.2 起生效，4.2.1 存量包需手动刷一次）
